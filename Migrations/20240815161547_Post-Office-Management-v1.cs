...
{
    /// <inheritdoc />
    public partial class PostOfficeManagementv1 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LoginIdentity = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsVPP = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WeightRange = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Charges_Services_ServiceTypeId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Delivery_FromOffice",
                        column: x => x.FromOfficeId,
                        principalTable: "Locations",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Delivery_ServiceType",
                        column: x => x.ServiceTypeId,
                        principalTable: "Services",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Delivery_ToOffice",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "0b6a3e4d-585f-4f29-b774-5389d457fb1f", null, "admin", "admin" },
                    { "1029b612-a5dd-4978-8c9c-14d8a88ba88d", null, "user", "user" },
                    { "ea6cb204-37eb-47c9-abdf-312aa79a5e4d", null, "employee", "employee" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Charges_ServiceTypeId",
                table: "Charges",
                column: "ServiceTypeId");

            migrationBuilder.CreateIndex(
                name: "IX_Deliverables_FromOfficeId",
                table: "Deliverables",
                column: "FromOfficeId");

            migrationBuilder.CreateIndex(
                name: "IX_Deliverables_ServiceTypeId",
                table: "Deliverables",
                column: "ServiceTypeId");

            migrationBuilder.CreateIndex(
                name: "IX_Deliverables_ToOfficeId",
                table: "Deliverables",
                column: "ToOfficeId");
        }
